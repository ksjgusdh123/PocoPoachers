...
public struct G_Shoot : IFlatbufferObject
{
  ...
  public bool IsHeadshot { get { int o = __p.__offset(20); return o != 0 ? 0!=__p.bb.Get(o + __p.bb_pos) : (bool)false; } }
  public int BulletSeqs(int j) { int o = __p.__offset(22); return o != 0 ? __p.bb.GetInt(__p.__vector(o) + j * 4) : (int)0; }
  public int BulletSeqsLength { get { int o = __p.__offset(22); return o != 0 ? __p.__vector_len(o) : 0; } }
#if ENABLE_SPAN_T
  public Span<int> GetBulletSeqsBytes() { return __p.__vector_as_span<int>(22, 4); }
#else
  public ArraySegment<byte>? GetBulletSeqsBytes() { return __p.__vector_as_arraysegment(22); }
#endif
  public int[] GetBulletSeqsArray() { return __p.__vector_as_array<int>(22); }
  ...
  public static Offset<G_Shoot> CreateG_Shoot(FlatBufferBuilder builder,
    ...
    G_Shoot.AddBulletSeqs(builder, bullet_seqsOffset);
    ...
    G_Shoot.AddIsHeadshot(builder, is_headshot);
    return G_Shoot.EndG_Shoot(builder);
  }

  public static void StartG_Shoot(FlatBufferBuilder builder) { builder.StartTable(10); }
  ...
  public static void AddIsHeadshot(FlatBufferBuilder builder, bool isHeadshot) { builder.AddBool(8, isHeadshot, false); }
  public static void AddBulletSeqs(FlatBufferBuilder builder, VectorOffset bulletSeqsOffset) { builder.AddOffset(9, bulletSeqsOffset.Value, 0); }
...
static public class G_ShootVerify
{
  static public bool Verify(Google.FlatBuffers.Verifier verifier, uint tablePos)
  {
    return verifier.VerifyTableStart(tablePos)
      ...
      && verifier.VerifyField(tablePos, 20 /*IsHeadshot*/, 1 /*bool*/, 1, false)
      && verifier.VerifyVectorOfData(tablePos, 22 /*BulletSeqs*/, 4 /*int*/, false)
