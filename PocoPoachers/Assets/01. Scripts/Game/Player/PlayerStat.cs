...
public class PlayerStat : StatBase
{
    ...
    {
        RoomSync.StatSync(hp, maxHp, CurrentStamina, CurrentBattery, DefenseRate, CritMultiplier, RangeMultiplier, LuckyShotChance, LuckyShotMultiplier, AttackPowerMultiplier, DefenseBuffRate);
    }
    ...
    {
        RoomSync.StatSync(CurrentHp, MaxHp, CurrentStamina, CurrentBattery, DefenseRate, CritMultiplier, RangeMultiplier, LuckyShotChance, LuckyShotMultiplier, AttackPowerMultiplier, DefenseBuffRate);
    }
