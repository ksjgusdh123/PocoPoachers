...
public class GunData : ScriptableObject
{
    ...
    [Header("크로스헤어 반동")]
    public float crosshairVerticalKick = 30f;
    public float crosshairHorizontalKick = 10f;
    public float crosshairShakeIntensity = 5f;
    public float crosshairShakeDuration = 0.1f;
