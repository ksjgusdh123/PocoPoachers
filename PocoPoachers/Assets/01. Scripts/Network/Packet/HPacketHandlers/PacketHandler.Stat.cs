...
public static partial class PacketHandlers
{
    public static void OnH_StatSync(FlatPacket root)
    {
        ...
        {
            remote.ApplyNetworkStats(packet.Hp, packet.MaxHp, packet.Stamina, packet.Battery, packet.Defense, packet.CritMultiplier, packet.RangeMultiplier, packet.LuckyChance, packet.LuckyMultiplier, packet.AttackPowerMultiplier, packet.DefenseBuffRate);
            return;
        }
