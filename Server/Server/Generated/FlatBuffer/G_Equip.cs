...
public struct G_Equip : IFlatbufferObject
{
  private Table __p;
  public ByteBuffer ByteBuffer { get { return __p.bb; } }
  public static void ValidateVersion() { FlatBufferConstants.FLATBUFFERS_24_3_25(); }
  public static G_Equip GetRootAsG_Equip(ByteBuffer _bb) { return GetRootAsG_Equip(_bb, new G_Equip()); }
  public static G_Equip GetRootAsG_Equip(ByteBuffer _bb, G_Equip obj) { return (obj.__assign(_bb.GetInt(_bb.Position) + _bb.Position, _bb)); }
  public void __init(int _i, ByteBuffer _bb) { __p = new Table(_i, _bb); }
  public G_Equip __assign(int _i, ByteBuffer _bb) { __init(_i, _bb); return this; }
  ...
  public static Offset<G_Equip> Pack(FlatBufferBuilder builder, G_EquipT _o) {
    if (_o == null) return default(Offset<G_Equip>);
    return CreateG_Equip(
      builder,
      _o.PlayerId,
      _o.ItemId,
      _o.ItemUid,
...
static public class G_EquipVerify
{
